...
def main():
    ...
    #args = parser.parse_args(['-f' 'simm_config.xlsx'])
    ...
    trades_simm = simm_lib.generate_trade_pos(input_file, params)
    run_cases = simm_lib.generate_run_cases(input_file, trades_simm)
